...
<body>
    ...
    <body class="bg-gray-950 p-20 flex justify-around">

        <div
            class="w-3/4 p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div>
                ...
                <div class="flex justify-between align-middle">
                    ...
                    <div class="inline-flex h-11">
                        <a href="/post/{{$post->id}}/edit" class="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2.5 px-4 rounded-l">
                            edit
                        </a>
                        <form action="/post/{{$post->id}}/delete" method="post" class="flex">
                            @csrf
                            @method('DELETE')
                            <input type="submit" class="  bg-red-900 hover:bg-red-800 text-white font-bold px-3 py-2 rounded-r" value="delete">
                            </input>
                        </form>
                    </div>
                </div>
                ...
                <div id="drawer-example"
                    ...
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">TU będą komentarze</p>
                </div>
